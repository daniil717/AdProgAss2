...
const file_proto_inventory_proto_rawDesc = "" +
	...
	"\fListProducts\x12\x10.inventory.Empty\x1a\x16.inventory.ProductList\x12A\n" +
	"\rDeleteProduct\x12\x14.inventory.ProductID\x1a\x1a.inventory.ProductResponseB#Z!inventory_service/proto;inventoryb\x06proto3"
...
var file_proto_inventory_proto_depIdxs = []int32{
	...
	3, // 5: inventory.InventoryService.CreateProduct:output_type -> inventory.ProductResponse
	0, // 6: inventory.InventoryService.GetProductByID:output_type -> inventory.Product
	2, // 7: inventory.InventoryService.ListProducts:output_type -> inventory.ProductList
	3, // 8: inventory.InventoryService.DeleteProduct:output_type -> inventory.ProductResponse
